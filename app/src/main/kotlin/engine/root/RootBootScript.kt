...
private fun <Config : RootModeStartConfig> StringBuilder.appendRootStartupPreamble(
    ...
    appendScript(
        $$"""
        #!/system/bin/sh
        # Generated by AsteriskBOX. This script is invoked by ROOT boot script.
    ...
    appendScript(
        ...
        echo "AsteriskBOX $$modeName startup"
    ...
    appendScript(
        ...
        chmod 755 $${config.root.runtimeLayout.singBoxCorePath.shellQuote()}
