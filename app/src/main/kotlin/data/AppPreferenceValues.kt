...
internal fun AppState.preferenceValues(): Map<String, AppPreferenceValue> = buildMap {
    ...
    string(KeyEbpfSharedDnsMode, ebpfSharedDnsMode)
    ...
    boolean(KeyServiceControlKeyguardEnabled, serviceControl.keyguard.enabled)
    boolean(KeyServiceControlKeyguardLockStart, serviceControl.keyguard.lockStart)
    boolean(KeyServiceControlKeyguardLockStop, serviceControl.keyguard.lockStop)
    boolean(KeyServiceControlKeyguardUnlockStart, serviceControl.keyguard.unlockStart)
    boolean(KeyServiceControlKeyguardUnlockStop, serviceControl.keyguard.unlockStop)
