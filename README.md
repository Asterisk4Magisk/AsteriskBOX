...
- [@xchacha20-poly1305/husi](https://github.com/xchacha20-poly1305/husi) — Apple networkQuality test (mensura.cdn-apple.com), settings UI, and the per-app proxy "Scan Chinese apps" idea
